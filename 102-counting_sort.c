...
/**
 * description- implementing counting sort algorithm
 * @array: Array to sort
...
/**
 * description - Creates an array that contain as indexes
...
/**
 * description - Get the max value of a gived array
...
/**
 * description on - sorts an array of integers in ascending order
