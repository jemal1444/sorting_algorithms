...
/**
 * description - return the position based on card you put in
...
/**
 *description - swap a card for his previous one
 *@deck: card deck
...
/**
 * description - function that sorts a doubly linked deck
...
/**
 * description - sort a deck you put in using
