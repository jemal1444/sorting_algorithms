...
#include <stdio.h>
/**
* description - A utility function to get maximum value in arr[]
* @arr: array
* @n: size of the array
* Return: array
*/
...
/**
* description - A function to do counting sort of arr[] according to
...
/**
* description - The main function to that sorts arr[]
