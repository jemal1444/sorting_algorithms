...
#include <stdio.h>
/**
 * description - change two values in ascending or descending order
 * @item1: item one
 * @item2: item two
...
/**
 * description - sort bitonic sequences recursively in both orders
 * @low: first element
...
/**
 * description - bitonic sort algorithm implementation
 * @low: first element
