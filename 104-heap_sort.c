...
/**
 * description - utility function to swap to integers
 * @a: integer a
 * @b: integer b
 **/
...
/**
 * description - The main function to heapify a Max Heap. The function
...
/**
 * description-  The main function to sort an array of given size
 * @array: array to sort
